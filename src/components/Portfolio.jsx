...
const Portfolio = () => {
  const portfolioItems = [
    { title: 'App 1', img: 'path/to/image1.jpg', text: 'Description for image 1', appLink: 'https://app1.com', repoLink: 'https://github.com/user/repo1' },
      ...
      {portfolioItems.map((item, index) => (
        <div key={index} style={{ display: 'flex', width: '100%', marginBottom: '20px' }}>
          <div style={{ width: '50%' }}>
            ...
            <h3>{item.title}</h3>
            <a href={item.appLink} target="_blank" rel="noopener noreferrer">View App</a>
            <a href={item.repoLink} target="_blank" rel="noopener noreferrer">View Code</a>
          </div>
